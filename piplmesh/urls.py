...
urlpatterns = patterns('',
    ...
    url(r'^password_reset/$', 'piplmesh.account.views.password_reset', name='password_reset'),
    url(r'^password_reset/done/$', 'piplmesh.account.views.password_reset_done', name='password_reset_done'),
    url(r'^reset/(?P<uidb36>[0-9A-Za-z]+)-(?P<token>[0-9A-Za-z]{1,13}-[0-9A-Za-z]{1,20})/$',
        'piplmesh.account.views.password_reset_confirm', name='password_reset_confirm'),
    url(r'^reset/done/$', 'piplmesh.account.views.password_reset_complete', name='password_reset_complete'),
