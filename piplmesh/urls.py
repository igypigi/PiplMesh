...
urlpatterns = patterns('',
    ...
    url(r'^account/password/reset/$', account_views.PasswordResetView.as_view(), name='password_reset'),
    url(r'^account/password/reset/token/(?P<confirmation_token>\w+)/$', account_views.PasswordResetTokenView.as_view(),
        name='password_reset_token'),
    url(r'^account/confirmation/$', account_views.EmailConfirmationSendToken.as_view(),
        name='email_confirmation_send_token'),
    url(r'^account/confirmation/token/(?:(?P<confirmation_token>\w+)/)?$',
        account_views.EmailConfirmationProcessToken.as_view(), name='email_confirmaton_process_token'),
