...
def password_reset(request, is_admin_site=False,
    ...
    if post_reset_redirect is None:
        post_reset_redirect = urlresolvers.reverse_lazy('piplmesh.account.views.password_reset_done')
...
def password_reset_confirm(request, uidb36=None, token=None,
    ...
    if post_reset_redirect is None:
        post_reset_redirect = urlresolvers.reverse('piplmesh.account.views.password_reset_complete')
    try:
        uid_int = base64.b64decode(uidb36)
